...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
 ...
 //   private int PROXIMITY_RADIUS = 5000;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  Button button = (Button) findViewById(R.id.btnHospital);
      //  btn3.setOnClickListener(new View.OnClickListener() {
         //   public void onClick(View v) {
               // Intent intent3 = new Intent(getApplicationContext(),ambulnace.class);
...
*/
    ...
    public void onLocationChanged(Location location) {
       ...
       //  Toast.makeText(this,cnic,Toast.LENGTH_SHORT).show();
       ...
       // String regno="1234";
        ...
        try {
            ...
            HttpPost httpPost = new HttpPost("http://lifesavior.pk/dataentrydriver.php?regno="+regno+"&cnic"+cnic+"&lat"+lat+"&lng"+lng+"&status"+status+"&dept"+dept);
