...
public class location extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        btnr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(location.this,"Nearby Hospitals", Toast.LENGTH_LONG).show();
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //31.502797,74.366245
                Double lati=31.502797;
                Double longi=74.366245;
        ...
        mMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                ...
                Toast.makeText(location.this,"Nearby Hospitals"+ lat+lng, Toast.LENGTH_LONG).show();
                Double lat1= mLastLocation.getLatitude();
                Double lng1=mLastLocation.getLongitude();
                MarkerPoints.add(new LatLng(lat1,lng1));
